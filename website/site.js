const messages = {
  en: {
    ...
    'quick.step1Body': 'Run the local server on your Mac. The terminal prints LAN URLs that Windows can open.',
    ...
    'quick.step3Body':
      'Keep the Windows PowerShell agent open. Back on Mac, use the web console, CLI, or AI tools to run real Windows work.',
    'quick.note':
  ...
  zh: {
    ...
    'quick.step1Body': '在 Mac 上启动本地服务。终端会打印 Windows 可以打开的局域网 URL。',
    ...
    'quick.step3Body': '保持 Windows PowerShell Agent 窗口打开。回到 Mac 后，用 Web 控制台、CLI 或 AI 工具执行真实的 Windows 操作。',
